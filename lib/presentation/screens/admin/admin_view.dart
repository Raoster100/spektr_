...
class AdminView extends StackedView<AdminViewModel> {
  const AdminView(this.rentService, this.orderService, this.workService, this.vacancyService, {Key? key}) : super(key: key);
  ...
  AdminViewModel viewModelBuilder(BuildContext context) {
    return AdminViewModel(rentService, orderService, workService, vacancyService)
  }
}
